...
The materials properties that have been set are detailed in Table \ref{tab:materials properties} and their thermal dependency is shown on Figure \ref{fig:properties}.
