...
% flux
% The permeation flux towards the cooling channel 
% \begin{figure} [h]
%     \centering
%     \includegraphics[width=\linewidth]{Figures/Chapter3/monoblocks/3D_monoblocks/permeation_flux_vs_thickness.pdf}
%     \caption{Temporal evolution of the permeation flux with or without recombination at the poloidal gap for several monoblock thicknesses.}
