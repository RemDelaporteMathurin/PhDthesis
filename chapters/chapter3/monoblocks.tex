...
For the continuous cases, the inventory evolves as a power law of the fluence (straight line on a log-log scale).
For the cycled simulations, spikes appear periodically (between every cycle).
These spikes correspond to ramp-down and ramp-ups during the cycles.
