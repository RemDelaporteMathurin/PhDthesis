...
The verification \& validation process (often called V\&V) has two goals: (1) showing that the governing equations are solved correctly and that the code is error free and (2) showing that the governing equations actually represent real life processes.
