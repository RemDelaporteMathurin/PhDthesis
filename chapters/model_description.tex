...
The \textcolor{black}{backward} rate constant $k^-_\mathrm{A,B}$ is the dissociation rate and is obtained using chemical equilibrium principles\sidecite{goldstein_diffusion_2007}:
\begin{equation}
