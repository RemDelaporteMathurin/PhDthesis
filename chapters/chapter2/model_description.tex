...
In other words, verification is answering the question \texit{"Are we building the code right?"} and validation is answering the question \texit{"Are we building the right code?"}.
