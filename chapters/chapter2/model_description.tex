...
Similarly, a dissociation flux can be applied when a surface is in contact with a gas atmosphere of H:
\begin{equation}
...
\subsection{Interface condition: conservation of chemical potential}\refsec{conservation of chemical potential}
...
\end{equation}
where $U_i$ are the coefficient to be determined one each node (called degrees of freedom).
