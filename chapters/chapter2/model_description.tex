...
This section will illustrate the finite element method applied to the Poisson equation \sidecite{logg_automated_2012}.
...
\begin{align}
    ...
    u &= 0 \quad \text{on    } \Gamma_D  \subset \delta \Omega \\
...
\begin{figure} [h]
    \centering
    \includegraphics[trim=100 0 250 0, clip, width=0.5\linewidth]{Figures/Chapter2/finite_element_problem_sketch.pdf}
...
\begin{equation}
    \int_{\Omega} \nabla u \cdot \nabla \ v \ dx = \int_{\Omega} f \ v \ dx + \int_{\Gamma_N} \frac{\partial u}{\partial n} \ v \ dx + \int_{\Gamma_D} \frac{\partial u}{\partial n} \ v \ dx \quad \forall \ v \in \hat{V}
...
\begin{equation}
    \int_{\Omega} \nabla u \cdot \nabla v  \ dx = \int_{\Omega} f \ v \ dx - \int_{\Gamma_N} g \ v \ dx \quad \forall \ v \in \hat{V}
    \label{eq: weak form 3}
\end{equation}

The test function $V$ is defined as:
\begin{equation}
