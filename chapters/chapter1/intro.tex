...
In most tokamaks, the escaping plasma is diverted towards a dedicated component that is heat-resistant (see Figure \ref{}).
Such a configuration is called a \textit{divertor} configuration.


\begin{itemize}
    \item Different types of divertors (single-null, double-null)
\end{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{Figures/Chapter1/inner_target_iter.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{Figures/Chapter1/monoblocks_with_pipe.png}
