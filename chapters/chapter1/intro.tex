...
\begin{figure} [h!]
    ...
    \begin{subfigure}{\linewidth}
        ...
        % \begin{overpic}[width=\linewidth, grid]{Figures/Chapter1/potential_energy_diagram.pdf}
...
Species can be trapped at defects (vacancies, interstitial atoms, impurities, etc.).
