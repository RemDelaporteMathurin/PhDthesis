...
The deuterium-tritium (DT) reaction is the one with the highest cross-section (measure of the reaction probability) at "low" temperature (see Figure \ref{fig: fusion cross sections}).
