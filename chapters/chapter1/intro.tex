...
The first part of this work was to develop a modelling tool - FESTIM - capable of solving hydrogen transport problem in 2D/3D (Chapter \ref{Chapter2}).
Monoblock level FESTIM simulations were then run and the tritium retention was estimated (Chapter \ref{Chapter3}).
The next stage was to scale up from a monoblock model to a full divertor model (Chapter \ref{Chapter4}).
Finally, the influence of helium exposure and the presence of helium bubbles was studied (Chapter \ref{Chapter5}).
