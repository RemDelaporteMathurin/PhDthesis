...
\begin{figure}
    ...
    \caption{Triple product. An interactive version of this plot is available at \href{https://remdelaportemathurin.github.io/fusion-world/}.}
...
Hydrogen diffusion is thermally activated and the diffusion coefficient $D$ expressed in \si{m^2.s^{-1}} follows an Arrhenius law:
\begin{equation}
    D = D_0 \exp{-E_D/k_B T}
\end{equation}
Hydrogen diffusion in metals has been studied both experimentally and numerically.
...
\end{equation}
This relationship is known as Henry's law of solubility and $K_H = \frac{K_\mathrm{abs}}{K_\mathrm{des}}$ is the material solubility expressed in \si{m^{-3}.Pa^{-1}}.

When the absorption/desorption order is $n=2$ (diatomic absorption):
\begin{equation}
    c_\mathrm{surface} = K_S \sqrt{P}
\end{equation}
This equilbrium is known as Sievert's law of solubility and $K_S = \sqrt{2 \frac{K_\mathrm{abs}}{K_\mathrm{des}}}$ is the material solubility expressed in \si{m^{-3}.Pa^{-0.5}}.
...
\subsection{He/W}
% same processes as H in W with additional processes specific to He
\begin{figure*}[h]
