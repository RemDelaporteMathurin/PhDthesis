...
\begin{itemize}
    ...
    \item why we care about Hydrogen in materials: safety, embrittlement, recycling fluxes (plasma)
    \item Safety issue --> 1kg of T max in ITER in-vessel components
\end{itemize}

\section{The tritium issue}

Tritium is an issue for safety, but is also the key ingredient of nuclear fusion.

\subsection{Tritium breeding}
\begin{itemize}
    \item Tritium self sufficiency
    \item tritium is radioactive and decays
    \item T must be produced
    \item Li + T
    \item Breeding blankets or molten salts
\end{itemize}
...
\begin{itemize}
    ...
    \item Intense particle fluxes
    \item plasma surface interactions
\end{itemize}
...
As shown on Figure \ref{fig: potential diagrams}, defects can act as a potential well for solute species.
...
Species can be trapped at vacancies, interstitial atoms, impurities, etc.
...
If their size is big enough the cluster pressure is sufficient to knock off a W atom from the lattice, creating a W vacancy and an interstitial W atom (a Frenkel pair).
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{Figures/Chapter1/code_comparison_table.png}
    \label{TO BE REPLACED BY AN ACTUAL TABLE}
\end{figure}

\section{Roadmap}

This PhD work aims at estimating the retention H isotopes in tokamak divertors.
