\subsection{Code comparison} \labsec{tendril case}
...
\begin{figure*}
    ...
    \caption{Helium clusters concentration profiles with dissociation energies varying from -\SI{0.5}{eV} (dash-point) to +\SI{0.5}{eV} (dash).}
