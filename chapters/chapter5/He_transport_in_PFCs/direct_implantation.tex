...
From this average \gls{He} content in bubbles and from Equations \refeq{radius average} and \refeq{radius pure He} expressing the clusters radii, the average radius $\langle r \rangle$ can be computed as:
