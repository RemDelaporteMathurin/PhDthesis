...
When extending the temporal derivative, one can obtain:

\begin{subequations}
    \begin{align}
        \frac{\partial \langle i_b \rangle }{\partial t} &\approx (N +1) \frac{\partial c_b }{\partial t} - \langle i_b \rangle \frac{\partial c_b }{\partial t} \\
        &\approx \frac{\partial c_b }{\partial t} ( N + 1 - \langle i_b \rangle)
    \end{align}
\end{subequations}
