...
A typical \gls{tem} image of the lamella is presented in Figure \ref{fig: tem images}.
...
A procedure was developed to automate the bubble detection on \textcolor{black}{\gls{tem} images using the ImageJ software~\sidecite{schindelin_fiji_2012}}.
The area of bubbles were computed as well as their diameter assuming a spherical shape for the bubbles.
Bubble density and size as a function of depth was therefore computed using \textcolor{black}{12 pairs of under- and over-focused \gls{tem} images}.
