...
At low fluences, He diffused really quickly into the bulk (see \reffig{profiles half slab}) and the bubbles concentration $c_b$ was found to be zero.
...
For every $(T, \varphi_\mathrm{imp})$ couple, $I_\mathrm{bubbles}$ increased rapidly at low fluences until reaching a maximum at high fluences (see \reffig{inventory bubbles time}).
On the other hand, the mean He content $\Bar{\langle i_b \rangle}$ was constant at low fluences and increased as a power law of time at high fluences (see \reffig{mean ib time}).
