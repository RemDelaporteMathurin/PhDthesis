...
\begin{figure}[ht!]
    ...
    \caption{Idealised potential energy diagram describing the interactions of H at the interface between two materials. In this case, $E_\mathrm{S,1}>E_\mathrm{S,2}$ (consistent with a W/Cu interface Table~\ref{tab:materials properties}).}
    \label{fig:diagram_E}
\end{figure}
